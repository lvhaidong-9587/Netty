...
public class LogEventDecoder extends MessageToMessageDecoder<DatagramPacket> {
    ...
    @Override
    protected void decode(ChannelHandlerContext channelHandlerContext, DatagramPacket logEvent, List<Object> list) throws Exception {
        //获取对 DatagramPacket 中的数据（ByteBuf）的引用
        ByteBuf data = logEvent.content();
        //获取该 SEPARATOR 的索引
        ...
        LogEvent event = new LogEvent(logEvent.sender(),
